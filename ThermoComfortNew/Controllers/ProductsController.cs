...
namespace ThermoComfortNew.Controllers
{
    public class ProductsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ProductName,Description,ImageUrl,Price,Availability,Characteristics,Brand,CreatedOn,IsDeleted,CategoryId")] Product product)
        {
