...
namespace ThermoComfortNew.Data.Migrations
{
    ...
    [Migration("20250201173756_SeededProducts")]
            ...
            modelBuilder.Entity("ThermoComfort.Data.Models.Product", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedOn = new DateTime(2025, 2, 1, 19, 37, 55, 375, DateTimeKind.Local).AddTicks(4393),
                        ...
                        new
                        {
                            ...
                            CreatedOn = new DateTime(2025, 2, 1, 19, 37, 55, 375, DateTimeKind.Local).AddTicks(4398),
                        ...
                        new
                        {
                            ...
                            CreatedOn = new DateTime(2025, 2, 1, 19, 37, 55, 375, DateTimeKind.Local).AddTicks(4403),
                        ...
                        new
                        {
                            ...
                            CreatedOn = new DateTime(2025, 2, 1, 19, 37, 55, 375, DateTimeKind.Local).AddTicks(4407),
                        ...
                        new
                        {
                            ...
                            CreatedOn = new DateTime(2025, 2, 1, 19, 37, 55, 375, DateTimeKind.Local).AddTicks(4413),
                        ...
                        new
                        {
                            ...
                            CategoryId = 2,
                            Characteristics = "Вид Термопомпа: Сплит\r\nТип инвертор: Инвертор\r\nЗахранване: 380V\r\nХладилен Агент: R32\r\nМощност kW: 4 - 9 kW\r\nРаботен режим: Отопление и охлаждане\r\nЕнергиен клас отопление: A+++\r\nНиво на шум: 26 - 30dB\r\nWi-Fi: Да\r\nЦвят: Бял",
                            CreatedOn = new DateTime(2025, 2, 1, 19, 37, 55, 375, DateTimeKind.Local).AddTicks(4417),
                            Description = "Иновативна гама термопомпи. Компактен, ефективен и тих хиромодул. А+++ енергиен клас отопление. Серия ESTIA R32. Опция за свързване с WiFi. Удобни дистанционни управления. Произход Полша.",
                            ImageUrl = "https://daricclima.bg/ufiles/articles/1/2024/05/termopompa-toshiba-estia-hwt-601xwht6w-e-hwt-601hw-e-trifazna_4650.jpg",
                            IsDeleted = false,
                            Price = 9318.98m,
                        ...
                        new
                        {
                            ...
                            CreatedOn = new DateTime(2025, 2, 1, 19, 37, 55, 375, DateTimeKind.Local).AddTicks(4421),
                        ...
                        new
                        {
                            ...
                            CreatedOn = new DateTime(2025, 2, 1, 19, 37, 55, 375, DateTimeKind.Local).AddTicks(4425),
                            Description = "Стенен кондензационен котел за отопление и производство на БГВ с външен обемен бойлер. Нов дизайн, ефективност и технология Hydrogen Ready.",
                        ...
                        new
                        {
                            ...
                            CreatedOn = new DateTime(2025, 2, 1, 19, 37, 55, 375, DateTimeKind.Local).AddTicks(4430),
                        ...
                        new
                        {
                            ...
                            CreatedOn = new DateTime(2025, 2, 1, 19, 37, 55, 375, DateTimeKind.Local).AddTicks(4443),
                        ...
                        new
                        {
                            ...
                            CreatedOn = new DateTime(2025, 2, 1, 19, 37, 55, 375, DateTimeKind.Local).AddTicks(4447),
                        ...
                        new
                        {
                            ...
                            CreatedOn = new DateTime(2025, 2, 1, 19, 37, 55, 375, DateTimeKind.Local).AddTicks(4452),
                        ...
                        new
                        {
                            ...
                            CreatedOn = new DateTime(2025, 2, 1, 19, 37, 55, 375, DateTimeKind.Local).AddTicks(4456),
                        ...
                        new
                        {
                            ...
                            CreatedOn = new DateTime(2025, 2, 1, 19, 37, 55, 375, DateTimeKind.Local).AddTicks(4460),
                        ...
                        new
                        {
                            ...
                            CreatedOn = new DateTime(2025, 2, 1, 19, 37, 55, 375, DateTimeKind.Local).AddTicks(4465),
                        ...
                        new
                        {
                            ...
                            CreatedOn = new DateTime(2025, 2, 1, 19, 37, 55, 375, DateTimeKind.Local).AddTicks(4469),
                        ...
                        new
                        {
                            ...
                            CreatedOn = new DateTime(2025, 2, 1, 19, 37, 55, 375, DateTimeKind.Local).AddTicks(4473),
                        ...
                        new
                        {
                            ...
                            CreatedOn = new DateTime(2025, 2, 1, 19, 37, 55, 375, DateTimeKind.Local).AddTicks(4478),
                        ...
                        new
                        {
                            ...
                            CreatedOn = new DateTime(2025, 2, 1, 19, 37, 55, 375, DateTimeKind.Local).AddTicks(4523),
                        ...
                        new
                        {
                            ...
                            CreatedOn = new DateTime(2025, 2, 1, 19, 37, 55, 375, DateTimeKind.Local).AddTicks(4527),
