...
namespace ThermoComfortNew.Areas.Identity.Pages.Account.Manage
{
    public class ChangePasswordModel : PageModel
    {
        ...
        {           
            ...
            [Compare("NewPassword", ErrorMessage = "Новата парола не съвпада с потвъждаването на паролата")]
        ...
        public async Task<IActionResult> OnPostAsync()
        {
            ...
            _logger.LogInformation("Променихте паролата успешно.");
            StatusMessage = "Променихте паролата успешно.";
